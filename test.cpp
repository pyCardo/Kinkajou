...
TEST_CASE("Testing move generation with PERFT") {
  ...
  SUBCASE("Position 2") {
    const auto start = std::chrono::high_resolution_clock::now();
    core::Board board("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -");
  ...
  SUBCASE("Position 4") {
    const auto start = std::chrono::high_resolution_clock::now();
    core::Board board("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq -");
  ...
  SUBCASE("Position 6") {
    const auto start = std::chrono::high_resolution_clock::now();
    core::Board board("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - -");
